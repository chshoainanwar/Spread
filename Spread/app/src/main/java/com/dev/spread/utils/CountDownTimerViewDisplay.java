 ...
 */
public class CountDownTimerViewDisplay extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private Boolean mCountDownTimerRunning = false;

    public CountDownTimerViewDisplay(Context context) {
        this(context, null);
    }

    public CountDownTimerViewDisplay(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownTimerViewDisplay(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public Boolean getmCountDownTimerRunning() {
