...
class DeleteVideoDialogCurrent : BaseDialogueFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvDesc.text = "Do you want to delete your current\nadvertisement?"
        ...
        binding.rlDelete.tvNext.setOnClickListener {
            toWelcome = "FromCurrentAds"
            dialog?.dismiss()
            findNavController().navigate(R.id.actionCurrentAdsToWelcome)
        }
        isCancelable = false
